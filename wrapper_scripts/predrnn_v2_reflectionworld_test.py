...
'--save_dir', '../../outputs_and_trained_networks/maintrain10k_20210814_input10',\
'--gen_frm_dir', '../../outputs_and_trained_networks/maintrain10k_20210814_input10',\
'--input_length', '10',\
'--total_length', '20',\
'--img_width', '128',\
'--img_channel', '1',\
'--model_name', 'predrnn_memory_decoupling',\
'--pretrained_model', '../../outputs_and_trained_networks/maintrain10k_20210814_input10/model.ckpt-40000',\
