...
class DataProcess:
    def __init__(self, input_param):
        ...
        self.train_scene = ['{}'.format(str(i).zfill(6)) for i in range(1,1800)]
        self.test_scene = ['{}'.format(str(i).zfill(6)) for i in range(1800,2100)]
    ...
    def load_data(self, paths, mode='train'):
        ...
        for c_dir in c_dir_list: # handwaving
            ...
            p_c_dir_list = os.listdir(c_dir_path) # list scene directories
